...
const CartPage = () => {
  ...
  const christmasChocolate = {
    ...
    "description": "A festive chocolate treat, only $1 this season! Perfect for a holiday gift or a sweet indulgence.",
    "price": 1.00,
    "stock": "infinite",
    "images": [
      "https://i.ibb.co/pPzPNWp/special-chocolate.png"
    ],
  ...
  return (
    <div className="p-6 bg-background text-primary min-h-screen mt-10">
      {/* Festive Banner */}
      <div className="bg-accentPrimary text-background p-4 rounded-lg mb-6 text-center shadow-md cursor-pointer" onClick={handleAddChocolateToCart}>
